      ...
      <div className='tcs__content'>
        ...
        <p className='tcs__paragraph'>
          <span>
            ...
            your purchase of NFTs as part of the Canelo v. Saunders: Face the
            Fearless NFT Drop (the “<b>Sale</b>”). BY PARTICIPATING IN THE SALE
            OR BIDDING IN ANY AUCTION IN CONNECTION WITH IT, YOU AGREE TO BE
            BOUND BY THESE TERMS AND ALL OF THE TERMS INCORPORATED HEREIN AND
        ...
        <p className='tcs__paragraph'>
          <span>
            ...
            TO SUBMIT CLAIMS YOU HAVE AGAINST DAZN TO BINDING AND FINAL
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            all times regardless of your decision to terminate usage of the NFT,
            any disruption to the operations of any components of the NFT, or
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            display the Art for your Licensed NFTs, solely for the following
            purposes: (i) for your own personal, non-commercial use; or (ii) as
            part of a third party website or application that permits the
            inclusion, involvement, or participation of your Licensed NFTs,
            provided that the website/application cryptographically verifies
            each NFT owner’s rights to display the Art for their Licensed NFTs
            ...
            Licensed NFT leaves the website/application. As it relates to the
            preceding rights, you shall be considered to control the Licensed
            Rights.
          </span>
        </p>
        <p className='tcs__paragraph'>
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            Licensed NFT, including but not limited to any transfer price and
            any other related compensation (so that if the transfer price is
            $100 then DAZN will be entitled to $10; or (2) if the transfer price
            is equivalent to $100 and an additional $50 is paid as related use
            fee then DAZN would be entitled to $15). Such payment must be paid
            on the terms no less beneficial than the terms on which you are
            paid, and at the same time as you are paid; (iii) You have not,
              ...
              >
                ...
                >
                  ...
                  <span>
                    ...
                    Canelo, personalised to that licensee.
                  </span>
                </p>
                <p
                  className='MsoNormal'
              ...
              >
                ...
                >
                  ...
                  <span>
                    ...
                    Hearn, personalised to that licensee.{' '}
                  </span>
                </p>
                <p
                  className='MsoNormal'
              ...
              >
                ...
                >
                  <span>
                    ...
                    from Eddie Hearn, personalised to that licensee.
                  </span>
                </p>
                <p
                  className='MsoNormal'
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            for your Licensed NFT in any way, including, without limitation, the
            shapes, designs, drawings, attributes, or color schemes; (ii) use
            the Licensed NFT and/or Art for your Licensed NFTs to advertise,
            market, or sell any product or service or in connection with
            political office of any kind; (iii) use the Licensed NFT and/or Art
            from your Licensed NFTs in connection with images, videos, or other
            forms of media that depict hatred, intolerance, violence, cruelty,
            or anything else that could reasonably be found to constitute hate
            speech or otherwise infringe upon the rights of others, drugs
            (including, without limitation, both prescription and
            non-prescription) or other supplements, death, pornography or other
            “adult only” or sexually explicit activities, prostitution or any
            dating or escort activities, weapons or ammunition, denigration or
            discrimination against individuals based on race, national origin,
            gender, religion, disability, ethnicity, sexual orientation, gender
            identity or age, medical conditions and/or political campaigns or
            causes; (iv) use the Licensed NFT and/or Art from your Licensed NFTs
            in movies, videos, or any other forms of media, except solely for
            your own personal, non-commercial use; (v) sell, distribute for
            commercial gain (including, without limitation, giving away in the
            hopes of eventual commercial gain), or otherwise commercialize
            merchandise that includes, contains, or consists of the Licensed NFT
            and/or Art from your Licensed NFTs; (vi) attempt to trademark,
            copyright, or otherwise acquire additional intellectual property
            rights in or to the Licensed NFT and/or Art from your Licensed NFTs;
            or (vii) otherwise utilize the Art from your Licensed NFTs for your
            or any third party’s commercial benefit. To the extent that the
            Licensed NFT and/or Art associated with your Licensed NFTs contains
            Third Party IP (e.g., licensed intellectual property from another
            individual or company), you understand and agree as follows: (A)
            that you will not have the right to use such Third Party IP in any
            way except as incorporated in the Art, and subject to the license
            and restrictions contained herein; (B) that, depending on the nature
            of the license granted from the owner of the Third Party IP, DAZN
            may need to pass through additional terms and/or restrictions on
            your ability to use the Art; and (C) to the extent that DAZN informs
            you of such additional restrictions in writing (email is
            permissible), you will be responsible for complying with all such
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            Licensed NFT for any reason except as specially provided in these
            T&amp;Cs); (ii) the email address you provided to DAZN is no longer
          ...
          <span>
            ...
            file a petition of bankruptcy; (iv) you engage in any unlawful
            business practice related to the Licensed NFT; or (v) you disparage
            DAZN and/or and each of their parent, subsidiary and affiliate
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            DIRECTORS, MEMBERS, AFFILIATES, AGENTS, ATTORNEYS AND EMPLOYEES. ALL
            LICENSED NFTs ARE PROVIDED “AS IS” AND “AS AVAILABLE” WITHOUT
            WARRANTIES OF ANY KIND EITHER EXPRESS OR IMPLIED. TO THE FULLEST
            EXTENT PERMISSIBLE PURSUANT TO APPLICABLE LAW, THE DAZN PARTIES
            DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, BUT NOT
            LIMITED TO, IMPLIED WARRANTIES OF NON-INFRINGEMENT, MERCHANTABILITY
            AND FITNESS FOR A PARTICULAR PURPOSE. TO THE FULLEST EXTENT
            PERMISSIBLE BY APPLICABLE LAW, IN NO EVENT SHALL THE DAZN PARTIES BE
            LIABLE TO YOU FOR ANY PERSONAL INJURY, PROPERTY DAMAGE, LOST
            ...
            DAMAGES, AND/OR ANY SPECIAL, INCIDENTAL, CONSEQUENTIAL, EXEMPLARY OR
            PUNITIVE DAMAGES BASED ON ANY CAUSES OF ACTION WHATSOEVER RELATED TO
            ANY NFT, INCLUDING BUT NOT LIMITED TO THE LICENSED NFT, THE SALE,
            ANY TECHNOLOGY AND/OR PARTIES RELATED TO THE SALE, INCLUDING BUT NOT
            LIMITED TO BLOCKCHAIN, METAMASK WALLET AND/OR OZONE NETWORKS, INC
            ...
            A DAZN PARTY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH LOSS OR
            DAMAGE, AND IN ANY EVENT, TO THE MAXIMUM EXTENT PERMITTED BY
            APPLICABLE LAW, THE DAZN PARTIES’ TOTAL AGGREGATE LIABILITY SHALL
            NOT EXCEED TEN PERCENT (10%) OF THE TOTAL VALUE PAID DIRECTLY BY YOU
            TO DAZN FOR THE APPLICABLE LICENSED NFT. YOU ACCEPT THE INHERENT
            SECURITY RISKS OF PROVIDING INFORMATION AND DEALING ONLINE OVER THE
            INTERNET AND AGREE THAT WE HAVE NO LIABILITY OR RESPONSIBILITY FOR
            ANY BREACH OF SECURITY UNLESS IT IS DUE TO OUR GROSS NEGLIGENCE. IF
            APPLICABLE LAW DOES NOT ALLOW ALL OR ANY PART OF THE ABOVE
            LIMITATION OF LIABILITY TO APPLY TO YOU, THE LIMITATIONS WILL
            CONTINUE TO APPLY TO YOU, BUT ONLY TO THE EXTENT PERMITTED BY
            APPLICABLE LAW.{' '}
          </span>
        </p>
        <p className='tcs__paragraph'>
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            within New York and without regard to conflict of law principles,
            except to the extent that law is inconsistent with or preempted by
            federal law. Any action related to these T&amp;Cs and/or any
            Licensed NFT shall be brought in the appropriate state or federal
            court located in New York County, New York; and you irrevocably
            consent to the exclusive jurisdiction and venue of the state or
            federal courts in New York County, New York for the adjudication of
            all claims.
          </span>
        </p>
        <p className='tcs__paragraph'>
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            of these T&amp;Cs accordingly. Please check these T&amp;Cs
            periodically for changes. Any changes to the T&amp;Cs will apply on
            the date that they are made and, by way of example, your continued
            access to or use of the Licensed NFT and the Art after the T&amp;Cs
            have been updated will constitute your binding acceptance of the
            updates.
          </span>
        </p>
        <p className='tcs__paragraph'>
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            herein. It is not available to Users who have had their User
            privileges temporarily or permanently deactivated. You may not allow
            other persons to use your User credentials, and you agree that you
            are the sole authorized user. (b) By becoming a User, you represent
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            shareholders, as well as DAZN Parties, harmless from any claims,
            ...
            purchase, sale or possession of a Licensed NFT, including: (1) your
            breach of this Agreement or any other document it incorporates by
            reference; (2) your violation of any law or the rights of a third
            party as a result of your own interaction with such third party; (3)
            any allegation that any materials that you submit to us or transmit
            in the course of the Sale, communications seeking DAZN’s consent to
            activities or otherwise, infringe or otherwise violate the
            copyright, trademark, trade secret or other intellectual property or
            other rights of any third party; and/or (4) any other activities in
            connection with the Sale or the Licensed NFT. This indemnity shall
            be applicable without regard to the negligence of any party,
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            below. This agreement to arbitrate (“<b>Arbitration</b>{' '}
            <b>Agreement</b>”) is governed by the Federal Arbitration Act and
            survives after the Agreement terminates or your relationship with
            DAZN ends.&nbsp;ANY ARBITRATION UNDER THIS AGREEMENT WILL TAKE PLACE
            ...
            DAZN, including our affiliates, subsidiaries, parents, successors
            and assigns, and each of our respective officers, directors,
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            BETWEEN YOU AND DAZN.&nbsp;These Claims include, but are not limited
            to, any dispute, claim or controversy, whether based on past,
            present, or future events, arising out of or relating to the Sale,
            this Agreement and prior versions thereof (including the breach,
            ...
            any promotions or offers made by DAZN, any city, county, state or
            federal trade secrets, unfair competition, discrimination,
            harassment, retaliation, fraud, defamation, emotional distress,
            breach of any express or implied contract or covenant, claims
            arising under federal or state consumer protection laws; claims
            arising under antitrust laws, claims arising under the Telephone
            Consumer Protection Act and Fair Credit Reporting Act; and claims
            arising under the Uniform Trade Secrets Act, Civil Rights Act of
            1964, Americans With Disabilities Act, and state statutes, if any,
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            ACTION WAIVER”). YOU UNDERSTAND AND AGREE THAT YOU AND DAZN BOTH ARE
            ...
            GENERAL ACT CLAIMS BROUGHT AGAINST DAZN, WHICH ARE ADDRESSED
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            civil court of competent jurisdiction, but the Class Action Waiver
            shall be enforced in arbitration on an individual basis as to all
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            arbitrator shall have the discretion to select a different set of
            AAA Rules, but in no event shall the arbitrator consolidate more
            than one person’s Claims, or otherwise preside over any form of
            representative, collective, or class proceeding. The parties may
            select a different arbitration administrator upon mutual written
            agreement. As part of the arbitration, both you and DAZN will have
            the opportunity for reasonable discovery of non-privileged
            information that is relevant to the Claim. The arbitrator may award
            any individualized remedies that would be available in court. The
            ...
            claims.&nbsp; The case shall be heard by one arbitrator, who shall
            be an executive with a company in the entertainment event production
            industry. The arbitrator will decide the substance of all claims in
            accordance with applicable law and will honor all claims of
            privilege recognized by law. The arbitrator shall not be bound by
            rulings in prior arbitrations involving different Users but is bound
            by rulings in prior arbitrations involving the same User to the
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            sole discretion and shall have the power to charge reasonable
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            the arbitration hearings will take place in the nearest available
            location for a AAA arbitration. Your right to a hearing will be
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            court’s jurisdiction. Where these claims are brought in a court of
            competent jurisdiction, DAZN will not require arbitration of those
            claims. DAZN's agreement not to require arbitration of these claims
            does not waive the enforceability of any other provision of this
            Arbitration Agreement, or of the enforceability of this Arbitration
            Agreement as to any other dispute, claim, or controversy. Nothing in
            this Arbitration Agreement shall be deemed to preclude or excuse a
            party from bringing an administrative claim before any agency in
            order to fulfill the party's obligation to exhaust administrative
            remedies before making a claim in arbitration However, should you
            bring an administrative claim, you may only seek or recover money
            damages of any type pursuant to this Arbitration Provision, and you
            knowingly and voluntarily waive the right to seek or recover money
            damages of any type pursuant to any administrative complaint.
            Nothing in this Agreement or Arbitration Agreement prevents your
            participation in an investigation by a government agency of any
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            not preempted by the FAA, such provision shall be severed, and the
        ...
        <p className='tcs__paragraph'>
          ...
          <span>
            ...
            time period is mutually extended by you and DAZN. A party who
            intends to seek negotiation under this subsection must first send to
            the other a written notice of the dispute (“<b>Notice</b>”). The
            Notice must (1) describe the nature and basis of the claim or
            dispute; and (2) set forth the specific relief sought. All offers,
            promises, conduct and statements, whether oral or written, made in
            the course of the negotiation by any of the parties, their agents,
            employees, and attorneys are confidential, privileged and
