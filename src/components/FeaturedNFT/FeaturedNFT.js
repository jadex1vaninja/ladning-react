  ...
  return (
    <div className='featured' id='auction'>
      <div className='featured__inner-wrapper'>
        ...
        <video controlslist="nodownload" loop muted playsinline="" autoplay="" poster={imgPath + 'Legendary_2_Knockout_Canelo_1_1.png'}>
        ...
        <div className='featured__content'>
          ...
          <div className='featured__CTA-wrap'>
            ...
            }} className='featured__CTA'>{t('featured-nft.CTA')}</button>
          </div>
        </div>
      </div>
    </div>
